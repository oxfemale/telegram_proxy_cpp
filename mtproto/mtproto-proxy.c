...
#define VERSION_STR	"Lulz.mtproxy-0.02"
const char FullVersionStr[] = VERSION_STR " make with love <(._.)>  at " __DATE__ " " __TIME__ " with no gluten gcc " __VERSION__ " "
#ifdef __LP64__
  "64-bit"
#else
  "32-bit"
#endif
"  rojdeno v mukah -  hibab larek: " COMMIT;
